            ...
            <div class="left_side">
                <div class="row content-part1 social-page">
                    <div class="col-lg-12 right-content-col">
                        ...
                        {!! Form::open(['method'=>'post','class'=>'form-horizontal','action'=>'Employer\EmployerJobsController@store']) !!}
                            <!--social-->
                            <div class="social_links">
                                <div class="social_title add_title">
                                    <p class="wow fadeInDown">Add new Job</p>
                                </div>
                                <div class="link col-lg-12 ">
                                    ...
                                    <div class="form-group wow fadeInDown">
                                        ...
                                        <div class="col-sm-8">
                                            <select  class="label ui selection fluid dropdown form-control" name="job_types[]" multiple="multiple" style="width: 100%">
                                              @foreach($job_types as $job_type)
                                                <option {{ (collect(old('job_types'))->contains($job_type->id)) ? 'selected':'' }} value="{{$job_type->id}}">{{$job_type->name}}</option>
                                                  @endforeach
                                            </select>
                                    ...
                                    <div class="form-group wow fadeInDown">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('experience',null,['class'=>'form-control','required','placeholder'=>'1+ Or 1-9 Or 1']) !!}
                                    ...
                                    <div class="form-group wow fadeInDown">
                                        ...
                                        <div class="col-sm-4">
                                            <label>from</label>
                                            {!! Form::number('start_salary',null,['class'=>'form-control','step'=>"0.01"]) !!}
                                        ...
                                        <div class="col-sm-4">
                                            <label>to</label>
                                            {!! Form::number('end_salary',null,['class'=>'form-control','step'=>"0.01"]) !!}
                                        ...
                                        <div class="col-sm-4">
                                            <select name="currency_id" class="form-control per">
                                                @foreach($currency_types as $currency_type)
                                                    <option value="{{$currency_type->id}}">{{$currency_type->name}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="1" name="hide_salary">
                                                    Hide Salary
                                                </label>
                            ...
                            <div class="col-lg-12">
                                <div class="des_social">
                                    <div class="form-group wow fadeInDown">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::textarea('job_description',null,['class'=>'form-control','id'=>'elm1']) !!}
                                    ...
                                    <div class="form-group wow fadeInDown" id="1">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="all_quest" id="questions">
                                                <div class="quest">
                                                    <input type="text" name="questions[]" class="col-md-10" value="Why Makes You Perfect for This Job?">
                                                    <span class="col-md-2">
                                                            <i class="fa fa-trash btn_remove" id="1" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group wow fadeInDown">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="all_quest">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="hide_company" value="1">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="email">
                                                        <input name="email_reference" value="{{$company->email_preference}}">
