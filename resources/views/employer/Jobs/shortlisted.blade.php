            ...
            <div class="candidate_link">
                <div class="col-lg-12">
                    <div class="left">
                        ...
                        <div class="col-lg-2">
                            <div class="accepeted" style="background-color: #C0C1C3">
                                    ...
                                    <div class="user  wow fadeInUp">
                                        <div class="Reviews_table table-responsive wow fadeInDown" style="overflow-x:auto;">
                                            <table class="table table-hover table-bordered table-responsive">
                                                ...
                                                <th>Age</th>
                                                <th>Apply Date</th>
                                                @foreach($job->jobApplicants->where('job_application_status_id',\Config::get('constants.SHORTLISTED')) as $applicant)
