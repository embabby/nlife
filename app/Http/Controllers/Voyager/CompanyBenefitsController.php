...
class CompanyBenefitsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('benefit_categories','dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
